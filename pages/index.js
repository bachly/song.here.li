        ...
        <Layout>
            <div className="bg-gray-900 relative overflow-x-hidden">
                <header className="relative" style={{ height: "100vh" }}>
                    <div className="absolute top-0 left-0 w-full z-0 bg-image bg-no-repeat bg-cover bg-blend-multiply"
                        style={{ backgroundImage: "url(/img/green-waves.svg)", height: "50vh" }}></div>
                    ...
                    <div style={{
                        ...
                        transform: "scale(4)",
                        background: "linear-gradient(rgb(11 47 60) 21%, rgb(23 23 23 / 83%) 98%)"
                    }}>
                        <svg>
                            <clipPath id="clip">
                    ...
                    <h1 className="relative z-10 px-4">
                        ...
                        <div className="text-gray-100 text-center text-4xl sm:text-5xl md:text-7xl">
                            <span className="font-bold">Worship</span>
                            <span className="font-light">Here</span>
                        </div>
                        <div className="mt-1 sm:mt-2 md:mt-3 text-center text-gray-100 text-sm md:text-xl">Personal Worship Song Books linked with AirTable</div>
                    </h1>
